-- 027: Fix bcrypt cost factor — GoTrue requires minimum cost 10.
-- gen_salt('bf') defaults to cost 6 on this instance; explicitly use cost 10.
...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    lower(p_email),
    extensions.crypt(v_password, extensions.gen_salt('bf', 10)),  -- cost 10, required by GoTrue
    now(),
